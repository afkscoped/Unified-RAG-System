...
This is the original Unified RAG System UI, now part of the
StoryWeaver multi-page application.
"""
...
st.caption("Unified RAG System • Hybrid Search + Semantic Caching + Adaptive Weights")
